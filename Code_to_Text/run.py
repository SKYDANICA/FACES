...
def convert_examples_to_features(js,tokenizer,args,idx):
    ...
    return InputFeatures(code_tokens,code_ids,nl_tokens,nl_ids,js['url'],idx)#,js['idx']
...
def main():
    ...
    # model.load_state_dict(torch.load("/home/fmy/newproject/codesearch/CodeXGLUE-main/Text-Code/NL-code-search-Adv/code/saved_models/dic/unicoder.bin"))
    # torch.save(model.encoder, "/home/fmy/newproject/codesearch/CodeXGLUE-main/Text-Code/NL-code-search-Adv/code/saved_models/dic/unixcode.pth")
    # import sys
    # sys.exit()
    ...
    if args.do_test and args.local_rank in [-1, 0]:
        ...
        model.load_state_dict(torch.load(output_dir))                  
        model.to(args.device)
        torch.save(model.encoder, '/home/fmy/newproject/yuanxing/PromptCS-main/code/saved_models/checkpoint-best-mrr/model_name.pth')
